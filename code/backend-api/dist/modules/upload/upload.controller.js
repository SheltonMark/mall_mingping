...
let UploadController = class UploadController {
    ...
    async uploadSingle(file, type) {
        return this.uploadService.uploadFile(file, type || upload_dto_1.UploadType.IMAGE);
    }
    async uploadMultiple(files, type) {
        return this.uploadService.uploadMultipleFiles(files, type || upload_dto_1.UploadType.IMAGE);
    }
