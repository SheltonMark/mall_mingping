...
let CustomerController = class CustomerController {
    ...
    findAll(search, salespersonId, customerType, page, limit) {
    ...
    assignSalesperson(id, salespersonId) {
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('salespersonId')),
...
__decorate([
    (0, common_1.Patch)(':id/assign-salesperson'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('salespersonId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], CustomerController.prototype, "assignSalesperson", null);
