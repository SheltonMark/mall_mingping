...
import { User, ShoppingCart, LogOut, Menu, X, UserPlus } from 'lucide-react'
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6">
        <div className="flex items-center justify-between relative z-10">
          ...
          <nav className="hidden md:flex items-center gap-4 md:gap-12 absolute left-1/2 -translate-x-1/2" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", "Helvetica Neue", Arial, sans-serif' }}>
            <Link
              href="/"
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-large border border-neutral-200 dark:border-gray-700 py-2 z-50" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Helvetica Neue", Arial, sans-serif' }}>
                  {isAuthenticated ? (
                    ...
                    <>
                      <Link
                        href="/login"
                        className="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gold-50 dark:hover:bg-gray-700 transition-colors w-full text-left"
                        onClick={() => setIsUserMenuOpen(false)}
                      >
                        <User className="w-4 h-4" />
                        <span>登录</span>
