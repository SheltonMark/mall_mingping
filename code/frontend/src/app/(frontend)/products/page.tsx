                ...
                currentProducts.map((productGroup) => {
                  ...
                  return (
                    <div key={productGroup.id} className="group relative flex flex-col gap-3 pb-3">
                      {/* Product Image */}
                      <div className="relative w-full aspect-square overflow-hidden rounded-none bg-gray-200 dark:bg-gray-800">
                        ...
                        {/* Added Feedback */}
                        {isAdded && (
                          <div className="absolute inset-0 flex items-center justify-center bg-black/40 rounded-none">
