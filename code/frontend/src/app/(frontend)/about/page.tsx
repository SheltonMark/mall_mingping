    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Helvetica Neue", Arial, sans-serif' }}>
      ...
      <section className="bg-white">
        ...
        <div className="grid md:grid-cols-2 items-start gap-0 -mt-1">
          <div className="h-[350px] md:h-[400px] overflow-hidden self-center order-2 md:order-1 transition-all duration-700" data-scroll-id="story-2-image">
            <img
          ...
          <div className="pl-12 md:pl-16 h-[350px] md:h-[400px] w-full flex flex-col justify-end pb-8 md:pb-12 order-1 md:order-2 transition-all duration-700" data-scroll-id="story-2-text">
            <h3 className="text-4xl md:text-5xl font-bold mb-6">
