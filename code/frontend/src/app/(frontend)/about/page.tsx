    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Helvetica Neue", Arial, sans-serif' }}>
      ...
      <section className="bg-white">
        ...
        <div className="grid md:grid-cols-2 items-start gap-0">
          <div className="p-0 transition-all duration-700" data-scroll-id="story-1-text">
        ...
        <div className="grid md:grid-cols-2 items-end gap-0 -mt-1">
          ...
          <div className="p-0 text-right order-1 md:order-2 transition-all duration-700" data-scroll-id="story-2-text">
            <h3 className="text-4xl md:text-5xl font-bold mb-6">
