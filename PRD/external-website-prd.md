...
前端现在被一层遮罩遮住了！动不了了 刚才我是去点击订单确认 然后就跳到登录页面 222这个账户没登上去 换了111 登上去之后 又点击订单确认页 又跳到登录页了

产品详情页硬编码替换 - 需要替换约15处硬编码文本
订单确认页面颜色组合 - 需要添加颜色组合显示
个人中心日期中英文切换 - 需要根据语言格式化日期

修复页脚Our Story等文字的中英文切换
